...
package main;
        ...
        import dataStructures.description;
        import node.Node;
        import contact.Contact;
import src.secondary.Contact;
...
public class main {
    private description<Contact> linkedList;
    private Scanner scan;

    public Menu() {
        scan = new Scanner(System.in);
        linkedList = new description<Contact>();
    }
    ...
    private void sortList(description<Contact> linkedList){
        linkedList.sort();
    }
    ...
    public void viewChoice() {
        sortList(linkedList);
        while(true){
            Node<Contact> node = linkedList.getObject();
            if(node==null)
                break;
    ...
    public void deleteChoice() {
        ...
        Contact contact=linkedList.delete(position).getData();

        System.out.println(contact.getFirstName() + " " + contact.getLastName() + "'s contact deleted from list!");
    }
